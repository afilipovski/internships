    ...
    return (
        <div class="h-[88vh] flex flex-col justify-center">
            <div class="rounded-[40px] shadowCard text-center w-full md:w-6/12 mx-auto py-16">
                ...
                <div class="m-8">
                    <Link class="bg-finkiO py-4 px-8 rounded-xl text-white text-2xl" to="https://cas.finki.ukim.mk/cas/login?service=https%3A%2F%2Fcourses.finki.ukim.mk%2Flogin%2Findex.php">Најава</Link>
                </div>
            </div>
        </div>
);
